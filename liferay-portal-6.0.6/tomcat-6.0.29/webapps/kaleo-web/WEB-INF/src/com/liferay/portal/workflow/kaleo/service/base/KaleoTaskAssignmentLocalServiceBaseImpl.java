...
/**
 * The base implementation of the kaleo task assignment local service.
 *
 * <p>
...
public abstract class KaleoTaskAssignmentLocalServiceBaseImpl
	...
	public void deleteKaleoTaskAssignment(long kaleoTaskAssignmentId)
		...
		kaleoTaskAssignmentPersistence.remove(kaleoTaskAssignmentId);
	}
	...
	public KaleoTaskAssignment updateKaleoTaskAssignment(
		...
		return kaleoTaskAssignmentPersistence.update(kaleoTaskAssignment, true);
	}
