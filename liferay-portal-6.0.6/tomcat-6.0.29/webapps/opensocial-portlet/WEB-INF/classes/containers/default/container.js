...
"gadgets.lockedDomainSuffix" : "%host%",
...
"gadgets.jsUriTemplate" : "http://%host%/opensocial-portlet/gadgets/js/%js%",

//New configuration for iframeUri generation:
"gadgets.uri.iframe.lockedDomainSuffix" :  "%host%",
...
"gadgets.oauthGadgetCallbackTemplate" : "//%host%/opensocial-portlet/gadgets/oauthcallback",
...
"gadgets.osDataUri" : "http://%host%/opensocial-portlet/rpc",
...
"gadgets.features" : {
  ...
  "views" : {
      ...
      "isOnlyVisible" : false,
      "urlTemplate" : "http://%host%/opensocial-portlet/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://%host%/opensocial-portlet/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
  ...
  "opensocial" : {
    ...
    "path" : "http://%host%/opensocial-portlet/rpc",
    // Path to issue invalidate calls
    "invalidatePath" : "http://%host%/opensocial-portlet/rpc",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
  ...
  "osapi" : {
    ...
    "endPoints" : [ "http://%host%/opensocial-portlet/rpc" ]                   
  },
  "osml": {
